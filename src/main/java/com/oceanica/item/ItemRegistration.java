...
public class ItemRegistration {
    ...
    public static final String FOUND_BOOK_NOTES_ID = "find-book-dream-notes";
    public static final RegistryObject<Item> FOUND_BOOK_NOTES = ITEMS.register(FOUND_BOOK_NOTES_ID,
            () -> new DreamNotes(FOUND_BOOK_NOTES_ID));
